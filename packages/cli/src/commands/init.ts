...
import { generateEd25519Keypair, extractPublicFromPrivate } from '@0xsyncroot/opentrade-core/gmgn';
import { CHAINS, type Chain } from '@0xsyncroot/opentrade-core/chains';
